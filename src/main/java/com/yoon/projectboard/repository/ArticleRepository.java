...
import com.yoon.projectboard.domain.QArticle;
import com.yoon.projectboard.repository.querydsl.ArticleRepositoryCustom;
...
//        bindings.bind(root.title).first(StringExpression::likeIgnoreCase);  // like 'val'
        ...
        bindings.bind(root.hashtags.any().hashtagName).first(StringExpression::containsIgnoreCase);  //like '%val%'
        bindings.bind(root.createdBy).first(StringExpression::containsIgnoreCase);  //like '%val%'
        bindings.bind(root.createdAt).first(DateTimeExpression::eq);  //like '%val%'
    }
}
