...
class UserAccountServiceTest {
    ...
    @Test
    void givenNonexistentUserId_whenSearching_thenReturnsEmptyOptionalUserData() {
        //given
    ...
    @Test
    void givenUserParams_whenSaving_thenReturnsUserAccount() {
        //given
        UserAccount userAccount = createUserAccount("yoon");
        UserAccount savedUserAccount = createSigningUpUserAccount("yoon");
